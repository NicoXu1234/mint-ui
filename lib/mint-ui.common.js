...
/* harmony default export */ exports["a"] = {
  open: function open(options) {
      ...
      // reopen instance
      if(instance.toClosefunc) {
          clearTimeout(instance.toClosefunc);
          instance.toClosefunc = null;
      }
  ...
  close: function close() {
      if (instance) {
          if(instance.isShowing && !instance.visible) {
              __WEBPACK_IMPORTED_MODULE_0_vue___default.a.nextTick(function () {
                  if(!instance.isClosed) return;  // reopen instance
                  instance.toClosefunc = setTimeout(() => {
